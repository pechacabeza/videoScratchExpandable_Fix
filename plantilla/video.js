...
function initialiseMediaPlayer() {
	...
	//Enable click of the video area if is being viewed on desktop
	 if (screenad.deviceType === screenad.DEVICE_DESKTOP) {
	 	mediaPlayer.addEventListener('click', mainExit, false);
	 	//console.log('Desktop');
	 } else {
	 	//console.log(screenad.deviceType);
	 }
	...
	mediaPlayer.addEventListener('play', function() {
		...
		console.log('cambia a pausa');
		
	}, false);
	mediaPlayer.addEventListener('pause', function() {
		// Change the button to be a play button
		changeButtonType(playPauseBtn, 'play');
		console.log('cambia a play');
	}, false);
...
/*
function extraClick_1(e) {
  screenad.click('extra1');
  screenad.event('click_Extra_1');
}
*/